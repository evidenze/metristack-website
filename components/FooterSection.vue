    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-12 mb-12">
        ...
        <div class="lg:col-span-1">
          ...
          <p class="text-plaid-text-muted leading-relaxed mb-6 max-w-sm">
            The unified API for retail data. Connect to any commerce platform with a single integration.
          </p>
          
          <!-- Social Links -->
          <div class="flex space-x-4">
            <a href="#" class="text-plaid-text-muted hover:text-white transition-colors duration-200">
        ...
        <div>
          ...
          <ul class="space-y-4">
            ...
            <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-200">Quick Start</a></li>
            <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-200">Code Examples</a></li>
            <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-200">Status Page</a></li>
            <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-200">Community</a></li>
            <li><a href="#" class="text-gray-400 hover:text-white transition-colors duration-200">GitHub</a></li>
          </ul>
        </div>
        ...
        <div class="max-w-md">
          ...
          <form class="flex gap-3">
            <input 
              ...
              class="flex-1 bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-500 focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-colors"
            >
            <button 
              type="submit"
              class="bg-primary-600 hover:bg-primary-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors duration-200 shadow-stripe-sm whitespace-nowrap"
            >
              Subscribe
            </button>
          </form>
