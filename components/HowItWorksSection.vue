    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="mb-16">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <!-- Step 1 -->
          <div class="bg-white rounded-xl p-8 shadow hover:shadow-lg transition-all duration-300 border border-l-4 border-l-accent-orange border-orange-100">
          ...
          <!-- Step 2 -->
          <div class="bg-white rounded-xl p-8 shadow hover:shadow-lg transition-all duration-300 border border-l-4 border-l-accent-blue border-blue-100">
            <div class="text-center">
          ...
          <div>
            ...
            <div class="space-y-6">
              <div class="flex items-start">
                ...
                <div>
                  <div class="font-semibold text-text-primary mb-1">RESTful APIs</div>
                  <div class="text-sm text-text-muted leading-relaxed">Intuitive endpoints that follow REST conventions</div>
                </div>
              </div>

              <div class="flex items-start">
                <div class="w-8 h-8 bg-blue-50 rounded-full flex items-center justify-center mr-4 mt-1 border border-blue-200">
                  <svg class="w-4 h-4 text-accent-blue" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                  </svg>
                </div>
                <div>
                  <div class="font-semibold text-text-primary mb-1">Real-time Webhooks</div>
                  <div class="text-sm text-text-muted leading-relaxed">Get notified instantly when data changes</div>
                </div>
              </div>

              <div class="flex items-start">
                <div class="w-8 h-8 bg-green-50 rounded-full flex items-center justify-center mr-4 mt-1 border border-green-200">
                  <svg class="w-4 h-4 text-accent-green" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                  </svg>
                </div>
                <div>
                  <div class="font-semibold text-text-primary mb-1">SDKs & Libraries</div>
                  <div class="text-sm text-text-muted leading-relaxed">Node.js, Python, PHP, and more coming</div>
                </div>
              </div>

              <div class="flex items-start">
                <div class="w-8 h-8 bg-purple-50 rounded-full flex items-center justify-center mr-4 mt-1 border border-purple-200">
                  <svg class="w-4 h-4 text-accent-purple" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                  </svg>
                </div>
                <div>
                  <div class="font-semibold text-text-primary mb-1">Comprehensive Docs</div>
                  <div class="text-sm text-text-muted leading-relaxed">Interactive API explorer and code samples</div>
                </div>
              </div>

              <div class="flex items-start">
                <div class="w-8 h-8 bg-pink-50 rounded-full flex items-center justify-center mr-4 mt-1 border border-pink-200">
                  <svg class="w-4 h-4 text-accent-pink" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"></path>
                  </svg>
                </div>
                <div>
                  <div class="font-semibold text-text-primary mb-1">Sandbox Environment</div>
                  <div class="text-sm text-text-muted leading-relaxed">Test with realistic data before going live</div>
                </div>
              </div>
            </div>
          </div>
...
<script setup>
// How It Works section showing the 3-step integration process
</script>