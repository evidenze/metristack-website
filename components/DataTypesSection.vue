    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-20">
        <h2 class="text-3xl md:text-4xl font-bold text-center text-gray-900 mb-4">
          Access any retail data. <span class="text-blue-600">From any platform.</span>
        </h2>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-20">
        ...
        <div class="bg-white rounded-xl p-8 shadow hover:shadow-lg transition-all duration-300 border border-gray-100">
          <div class="flex items-center mb-6">
            ...
            <div>
              ...
              <p class="text-blue-600 text-sm font-medium">Complete transaction insights</p>
            </div>
          </div>
        ...
        <div class="bg-white rounded-xl p-8 shadow hover:shadow-lg transition-all duration-300 border border-gray-100">
          <div class="flex items-center mb-6">
            ...
            <div>
              ...
              <p class="text-blue-600 text-sm font-medium">360-degree customer view</p>
            </div>
          </div>
          <p class="text-gray-600 mb-6 leading-relaxed">
        ...
        <div class="bg-white rounded-xl p-8 shadow hover:shadow-lg transition-all duration-300 border border-gray-100">
          <div class="flex items-center mb-6">
            ...
            <div>
              ...
              <p class="text-blue-600 text-sm font-medium">Complete lifecycle tracking</p>
            </div>
          </div>
          <p class="text-gray-600 mb-6 leading-relaxed">
